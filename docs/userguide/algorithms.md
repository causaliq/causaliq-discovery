...
|---|---|---|---|
| [fges](algorithms/fges.md) | score | Tetrad/causal-cmd | Fast Greedy Equivalence Search |
...
| [hc](algorithms/hc.md) | score | CausalIQ | Hill-climbing |
...
| [tabu](algorithms/tabu.md) | score | CausalIQ | Hill-climbing with tabu list |
